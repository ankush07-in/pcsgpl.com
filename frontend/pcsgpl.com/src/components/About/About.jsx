    ...
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 flex flex-wrap gap-10">
          {/* Left Column: Images & Quotes */}
          <div className="w-full xl:w-5/12 space-y-6">
            <img src="assets/images/about/guru-blessings.jpg" alt="Guru Blessings" className="w-full rounded shadow-md" />
            <h2 className="text-lg font-semibold">
              An organization inspired by our master of love & smile to impact millions of lives in our society
            </h2>

            <img src="assets/images/about/1.jpg" alt="Drop Worries" className="w-full rounded shadow-md" />
            <h2 className="text-lg font-semibold">
            ...
            <img src="assets/images/about/our-mission.jpg" alt="Mission" className="w-full rounded shadow-md" />
            <h2 className="text-lg font-semibold">
            ...
            <img src="assets/images/about/buildyourcareer.jpg" alt="Build Career" className="w-full rounded shadow-md" />
            <h2 className="text-lg font-semibold">
          ...
          <div className="w-full xl:w-6/12 xl:ml-auto space-y-6">
            ...
            <div className="text-gray-700 space-y-4">
              ...
              <p className="font-medium">
                ...
                We specialize in securing operations, increasing data center efficiency, enhancing end-user support, and modernizing enterprise applications.
              </p>
              <p className="font-medium">
                Our offerings include Web Development, Systems Integration, Consulting, Infrastructure, Maintenance,
                and High-End Server Solutions across Corporate Institutes, Tourism, Banking, Telecom, Media, and more.
              </p>
            </div>

            <a href="#" className="inline-block mt-6 px-6 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700">
